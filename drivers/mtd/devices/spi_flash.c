...
*/
	...
	partitions[0].offset = 0x0;
	partitions[0].size = 0x80000;
	num++;
	// KERNEL
	partitions[1].name = "kernel";
        partitions[1].offset = 0x80000;
        partitions[1].size = 0x1d0000;
	num++;
	// ROMFS
	partitions[2].name = "romfs";
        partitions[2].offset = 0x250000;
        partitions[2].size = 0x490000;
	num++;
	// USER
	partitions[3].name = "user";
        partitions[3].offset = 0x6E0000;
        partitions[3].size = 0x520000;
	num++;
	// WEB,VOICE
	partitions[4].name = "web";
        partitions[4].offset = 0xC00000;
        partitions[4].size = 0x200000;
	num++;
	// CUSTOM
	partitions[5].name = "custom";
        partitions[5].offset = 0xE00000;
        partitions[5].size = 0x100000;
	num++;
     ...
     */
    partitions[6].name = "mtd";
    partitions[6].offset = 0;
    partitions[6].size = chip_size;
